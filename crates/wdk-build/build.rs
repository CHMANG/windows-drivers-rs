...
#[rustversion::nightly]
fn main() {println!("cargo:rustc-cfg=nightly_toolchain");}
...
fn getandset_rcfile(s1: String, s2: String, s3: String, s4:String, s5:String, s6:String) {
...
fn invoke_rc() {
    ...
    let status = Command::new(&rc_path).arg(resource_script).status();
